...
var $$req$ = require; require = (typeof $$ceylon$require == 'undefined') ? $$req$ : function() { return $$ceylon$require('ceylon/interop/browser/1.3.2-SNAPSHOT/ceylon.interop.browser-1.3.2-SNAPSHOT', $$req$, Array.prototype.slice.call(arguments)); }

var _CTM$;function $CCMM$(){if (_CTM$===undefined)_CTM$=require('ceylon/interop/browser/1.3.2-SNAPSHOT/ceylon.interop.browser-1.3.2-SNAPSHOT-model').$CCMM$;return _CTM$;}
ex$.$CCMM$=$CCMM$;
...
m$1.$addmod$(ex$,'ceylon.interop.browser/1.3.2-SNAPSHOT');
...
eventTarget$.addEventListener$defs$capture=function($3vk,$3vl,$3vm){return false;};
eventTarget$.removeEventListener$defs$capture=function($3vn,$3vo,$3vp){return false;};
}
...
function EventHandler$dom(){var $3vq={t:m$1.Callable,a:{Arguments$Callable:m$1.mtt$([{t:$init$Event()}]),Return$Callable:{t:m$1.Anything}}};$3vq.$crtmm$=function(){return{mod:$CCMM$,pa:1,d:['ceylon.interop.browser.dom','EventHandler']};};return $3vq;}
...
function newEvent$dom$defs$eventInitDict($3vr,$3vs){return null;};
function newEvent$dom($3vr,$3vs){if($3vs===undefined){$3vs=null;}
return newEventInternal$internal($3vr,$3vs);
};
...
function DOMTimeStamp$dom(){var $3vt={t:m$1.Integer};$3vt.$crtmm$=function(){return{mod:$CCMM$,pa:1,d:['ceylon.interop.browser.dom','DOMTimeStamp']};};return $3vt;}
...
function OnErrorEventHandler$dom(){var $3vu={t:m$1.Callable,a:{Arguments$Callable:m$1.mtt$([m$1.mut$([{t:m$1.$_String},{t:$init$Event()}]),m$1.mut$([{t:m$1.Null},{t:m$1.$_String}]),m$1.mut$([{t:m$1.Null},{t:m$1.Integer}]),m$1.mut$([{t:m$1.Null},{t:m$1.Integer}]),{t:m$1.Anything}]),Return$Callable:{t:m$1.Anything}}};$3vu.$crtmm$=function(){return{mod:$CCMM$,pa:1,d:['ceylon.interop.browser.dom','OnErrorEventHandler']};};return $3vu;}
ex$.OnErrorEventHandler$dom=OnErrorEventHandler$dom;
function OnBeforeUnloadEventHandler$dom(){var $3vv={t:m$1.Callable,a:{Arguments$Callable:m$1.mtt$([{t:$init$Event()}]),Return$Callable:m$1.mut$([{t:m$1.Null},{t:m$1.$_String}])}};$3vv.$crtmm$=function(){return{mod:$CCMM$,pa:1,d:['ceylon.interop.browser.dom','OnBeforeUnloadEventHandler']};};return $3vv;}
...
function Node(node$){
EventTarget(node$);
node$.cloneNode$defs$deep=function($3vw){return false;};
}
...
document$.importNode$defs$deep=function($3vx,$3vy){return false;};
document$.createNodeIterator$defs$whatToShow=function($3vz,$3w0,$3w1){return 4294967295;};
document$.createNodeIterator$defs$filter=function($3vz,$3w0,$3w1){return null;};
document$.createTreeWalker$defs$whatToShow=function($3w2,$3w3,$3w4){return 4294967295;};
document$.createTreeWalker$defs$filter=function($3w2,$3w3,$3w4){return null;};
document$.open$defs$typeOrUrl=function($3w5,$3w6,$3w7,$3w8){return "text/html";};
document$.open$defs$replaceOrName=function($3w5,$3w6,$3w7,$3w8){return "";};
document$.open$defs$features=function($3w5,$3w6,$3w7,$3w8){return "";};
document$.open$defs$replace=function($3w5,$3w6,$3w7,$3w8){return false;};
document$.execCommand$defs$showUI=function($3w9,$3wa,$3wb){return false;};
document$.execCommand$defs$val=function($3w9,$3wa,$3wb){return "";};
}
...
function openDocument$dom($3wc,$3wd){
if($3wc===undefined){$3wc="text/html";}
if($3wd===undefined){$3wd="";}
var $3we;
m$1.asrt$((m$1.is$(($3we=document$dom().open($3wc,$3wd)),{t:$init$Document()})),"Assertion failed: \'is Document doc = document.open(type, replace)\' at nodes.ceylon (196:11-196:58)",'196:4-196:59','nodes.ceylon');
return $3we;
}
...
function openWindow$dom($3wf,$3wg,$3wh,$3wi){
if($3wi===undefined){$3wi=false;}
var $3wj;
m$1.asrt$((m$1.is$(($3wj=document$dom().open($3wf,$3wg,$3wh,$3wi)),WindowProxy())),"Assertion failed: \'is WindowProxy doc = document.open(url, name, features, replace)\' at nodes.ceylon (204:11-204:76)",'204:4-204:77','nodes.ceylon');
return $3wj;
}
...
dOMImplementation$.createDocument$defs$doctype=function($3wk,$3wl,$3wm){return null;};
}
...
function newText$dom$defs$text($3wn){return "";};
function newText$dom($3wn){if($3wn===undefined){$3wn="";}
return newTextInternal$internal($3wn);
};
...
function newComment$dom$defs$data($3wo){return "";};
function newComment$dom($3wo){if($3wo===undefined){$3wo="";}
return newCommentInternal$internal($3wo);
};
...
range$.collapse$defs$toStart=function($3wp){return false;};
}
...
function newEventInternal$internal($3wq,$3wr){
obj=(typeof eval==='undefined'||eval===null?m$1.throwexc(m$1.Exception("Undefined or null reference: eval"),'14:14-14:17','nativeObjects.ceylon'):eval)("Event");return m$1.dre$$(($3ws=$3wq,$3wt=$3wr,$3wu=(typeof obj==='undefined'?m$1.throwexc(m$1.Exception("Undefined type obj"),'15:15-15:17','nativeObjects.ceylon'):obj),$3wu.$$===undefined?new $3wu($3ws, $3wt):$3wu($3ws, $3wt)),{t:$init$Event()},'nativeObjects.ceylon 15:15-15:40');
}
...
obj=(typeof eval==='undefined'||eval===null?m$1.throwexc(m$1.Exception("Undefined or null reference: eval"),'22:14-22:17','nativeObjects.ceylon'):eval)("XMLHttpRequest");return m$1.dre$$(($3wv=(typeof obj==='undefined'?m$1.throwexc(m$1.Exception("Undefined type obj"),'23:15-23:17','nativeObjects.ceylon'):obj),$3wv.$$===undefined?new $3wv():$3wv()),{t:$init$XMLHttpRequest()},'nativeObjects.ceylon 23:15-23:21');
}
...
function newTextInternal$internal($3ww){
obj=(typeof eval==='undefined'||eval===null?m$1.throwexc(m$1.Exception("Undefined or null reference: eval"),'29:14-29:17','nativeObjects.ceylon'):eval)("Text");return m$1.dre$$(($3wx=$3ww,$3wy=(typeof obj==='undefined'?m$1.throwexc(m$1.Exception("Undefined type obj"),'30:15-30:17','nativeObjects.ceylon'):obj),$3wy.$$===undefined?new $3wy($3wx):$3wy($3wx)),{t:$init$Text()},'nativeObjects.ceylon 30:15-30:25');
}
...
obj=(typeof eval==='undefined'||eval===null?m$1.throwexc(m$1.Exception("Undefined or null reference: eval"),'36:14-36:17','nativeObjects.ceylon'):eval)("Range");return m$1.dre$$(($3wz=(typeof obj==='undefined'?m$1.throwexc(m$1.Exception("Undefined type obj"),'37:15-37:17','nativeObjects.ceylon'):obj),$3wz.$$===undefined?new $3wz():$3wz()),{t:$init$Range()},'nativeObjects.ceylon 37:15-37:21');
}
...
function newCommentInternal$internal($3x0){
obj=(typeof eval==='undefined'||eval===null?m$1.throwexc(m$1.Exception("Undefined or null reference: eval"),'43:14-43:17','nativeObjects.ceylon'):eval)("Comment");return m$1.dre$$(($3x1=$3x0,$3x2=(typeof obj==='undefined'?m$1.throwexc(m$1.Exception("Undefined type obj"),'44:15-44:17','nativeObjects.ceylon'):obj),$3x2.$$===undefined?new $3x2($3x1):$3x2($3x1)),{t:$init$Comment()},'nativeObjects.ceylon 44:15-44:25');
}
...
window$.open$defs$url=function($3x3,$3x4,$3x5,$3x6){return "about:blank";};
window$.open$defs$target=function($3x3,$3x4,$3x5,$3x6){return "_blank";};
window$.open$defs$features=function($3x3,$3x4,$3x5,$3x6){return "";};
window$.open$defs$replace=function($3x3,$3x4,$3x5,$3x6){return false;};
window$.alert$defs$message=function($3x7){return "";};
window$.confirm$defs$message=function($3x8){return "";};
window$.prompt$defs$message=function($3x9,$3xa){return "";};
window$.prompt$defs$default=function($3x9,$3xa){return "";};
}
...
window$.alert={$fml:1,$crtmm$:function(){return{mod:$CCMM$,$t:{t:m$1.Anything},ps:[{nm:'message',mt:'prm',def:1,$t:{t:m$1.$_String}}],$cont:Window,pa:5,d:['ceylon.interop.browser','Window','$m','alert']};}};window$.confirm={$fml:1,$crtmm$:function(){return{mod:$CCMM$,$t:{t:m$1.$_Boolean},ps:[{nm:'message',mt:'prm',def:1,$t:{t:m$1.$_String}}],$cont:Window,pa:5,d:['ceylon.interop.browser','Window','$m','confirm']};}};window$.prompt={$fml:1,$crtmm$:function(){return{mod:$CCMM$,$t:{t:'u',l:[{t:m$1.Null},{t:m$1.$_String}]},ps:[{nm:'message',mt:'prm',def:1,$t:{t:m$1.$_String}},{nm:'default',mt:'prm',def:1,$t:{t:m$1.$_String}}],$cont:Window,pa:5,d:['ceylon.interop.browser','Window','$m','prompt']};}};window$.print={$fml:1,$crtmm$:function(){return{mod:$CCMM$,$t:{t:m$1.Anything},ps:[],$cont:Window,pa:5,d:['ceylon.interop.browser','Window','$m','print']};}};window$.setInterval={$fml:1,$crtmm$:function(){return{mod:$CCMM$,$t:{t:m$1.Integer},ps:[{nm:'f',mt:'prm',$t:{t:m$1.Callable,a:{Arguments$Callable:{t:m$1.Empty},Return$Callable:{t:m$1.Anything}}}},{nm:'millis',mt:'prm',$t:{t:m$1.Integer}},{nm:'params',mt:'prm',seq:1,$t:{t:m$1.Sequential,a:{Element$Sequential:{t:m$1.Anything}}}}],$cont:Window,pa:5,d:['ceylon.interop.browser','Window','$m','setInterval']};}};window$.clearInterval={$fml:1,$crtmm$:function(){return{mod:$CCMM$,$t:{t:m$1.Anything},ps:[{nm:'id',mt:'prm',$t:{t:m$1.Integer}}],$cont:Window,pa:5,d:['ceylon.interop.browser','Window','$m','clearInterval']};}};window$.setTimeout={$fml:1,$crtmm$:function(){return{mod:$CCMM$,$t:{t:m$1.Integer},ps:[{nm:'f',mt:'prm',$t:{t:m$1.Callable,a:{Arguments$Callable:{t:m$1.Empty},Return$Callable:{t:m$1.Anything}}}},{nm:'millis',mt:'prm',$t:{t:m$1.Integer}},{nm:'params',mt:'prm',seq:1,$t:{t:m$1.Sequential,a:{Element$Sequential:{t:m$1.Anything}}}}],$cont:Window,pa:5,d:['ceylon.interop.browser','Window','$m','setTimeout']};}};window$.clearTimeout={$fml:1,$crtmm$:function(){return{mod:$CCMM$,$t:{t:m$1.Anything},ps:[{nm:'id',mt:'prm',$t:{t:m$1.Integer}}],$cont:Window,pa:5,d:['ceylon.interop.browser','Window','$m','clearTimeout']};}};window$.toString=function(){return this.string.valueOf();};
})(Window.$$.prototype);
}
return Window;
}
ex$.$init$Window=$init$Window;$init$Window();
function WindowProxy(){var $3xb={t:$init$Window()};$3xb.$crtmm$=function(){return{mod:$CCMM$,pa:1,d:['ceylon.interop.browser','WindowProxy']};};return $3xb;}
...
history$.pushState$defs$url=function($3xc,$3xd,$3xe){return null;};
history$.replaceState$defs$url=function($3xf,$3xg,$3xh){return null;};
}
...
xMLHttpRequest$.open$defs$async=function($3xi,$3xj,$3xk,$3xl,$3xm){return false;};
xMLHttpRequest$.open$defs$username=function($3xi,$3xj,$3xk,$3xl,$3xm){return null;};
xMLHttpRequest$.open$defs$password=function($3xi,$3xj,$3xk,$3xl,$3xm){return null;};
xMLHttpRequest$.send$defs$data=function($3xn){return null;};
}
